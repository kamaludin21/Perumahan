...
import inc.mtwo.perumahan.Adapter.RecyclerViewAdapter;
import inc.mtwo.perumahan.HomeActivity;
...
import inc.mtwo.perumahan.SessionManager;
...
public class RumahActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewAdapter = new RecyclerViewAdapter(this, rumah);
        ...
        call.enqueue(new Callback<Value>() {
            ...
            public void onResponse(Call<Value> call, Response<Value> response) {
                ...
                if (value.equals("1")) {
                    ...
                    viewAdapter = new RecyclerViewAdapter(RumahActivity.this, rumah);
                    recyclerView.setAdapter(viewAdapter);
                }
            }
    ...
    public void onBackPressed() {
        Intent i = new Intent(RumahActivity.this, MenuActivity.class);
        startActivity(i);
    }
}
